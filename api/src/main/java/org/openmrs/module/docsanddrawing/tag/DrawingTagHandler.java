package org.openmrs.module.docsanddrawing.tag;
		...
		public String generateHtml(FormEntryContext context) {
			...
			try {
				if (context.getMode() == FormEntryContext.Mode.VIEW) {
					sb.append(uiUtils.includeFragment("docsanddrawing", "encounterDetails"));
				} else {
					sb.append(uiUtils.includeFragment("docsanddrawing", "editor"));
				}
				return sb.toString();
			}
