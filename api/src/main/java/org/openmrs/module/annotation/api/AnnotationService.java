...
import org.openmrs.module.annotation.AnnotationConfig;
 ...
 */
public interface AnnotationService extends OpenmrsService {
	...
	Drawing getItemByUuid(String uuid) throws APIException;
	
	/**
	 * Saves an drawing. Sets the owner to superuser, if it is not set. It can be called by users
