...
import static org.openmrs.module.annotation.Utils.isValidMimeType;
...
public class ValueComplex {
	...
	public ValueComplex(String valueComplex) {
		// drawing | annotation.FILE | application/octet-stream | SampleVideo_640x360_10mb_01.mp4
		...
		if (!isValidMimeType(this.mimeType))
