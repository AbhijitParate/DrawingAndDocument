...
<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/webui-popover/2.1.15/jquery.webui-popover.min.css">
<link rel="stylesheet" type="text/css" href="https://vjs.zencdn.net/5.8.8/video-js.css">
<% ui.includeCss("annotation", "videojs.record.css") %>

<script src="https://code.jquery.com/jquery-1.12.4.js"></script>
<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/fabric.js/1.7.1/fabric.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/spectrum/1.8.0/spectrum.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/webcamjs/1.0.16/webcam.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf/1.3.2/jspdf.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/webui-popover/2.1.15/jquery.webui-popover.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.ui-contextmenu/1.13.0/jquery.ui-contextmenu.min.js" type="text/javascript"></script>
...
<body>
    ...
    <table>
        ...
        <tr>
            <td>${ ui.format(patientId) }   </td>
            <td>${ ui.format(visitId) }     </td>
    ...
    <div id="status-bar" class="bottomControlContainer">
        <button id="status-cancel" class="button-small float-right" title="Cancel">
        ...
        <button id="status-save" class="button-small float-right" title="Save">
            <svg style="width:24px;height:24px" viewBox="0 0 24 24">
        ...
        <button id="status-print" class="button-small float-right" title="Print">
            <svg style="width:24px;height:24px" viewBox="0 0 24 24">
        ...
        <button id="status-clear" class="button-small float-right" title="Clear">
            <svg style="width:24px;height:24px" viewBox="0 0 24 24">
        ...
        <button id="status-view-attachments" class="button-small float-right" title="Attachments">
            <svg style="width:24px;height:24px" viewBox="0 0 24 24">
    ...
    <div id="controlsContainer" class="controlsContainer">
        <div id="controls">
            ...
            <div style="padding:1%;">
                <button id="pencil" class="button-regular ui-button ui-widget ui-corner-all" title="Pencil">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                ...
                <button id="erase" class="button-regular not-available ui-widget ui-corner-all" title="Eraser">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                ...
                <button id="shape" class="button-regular ui-button ui-widget ui-corner-all" title="Shapes">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                ...
                <button id="delete" class="button-regular ui-button ui-widget ui-corner-all" title="Delete">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                ...
                <button id="text" class="button-regular ui-button ui-widget ui-corner-all" title="Text">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                ...
                <button id="color-picker" class="button-regular ui-button ui-widget ui-corner-all" title="Color Palette">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                ...
                <button id="select" class="button-regular ui-button ui-widget ui-corner-all" title="Select">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
            ...
            <div style="padding: 1%;">
                <button id="flip-vertical" class="button-regular ui-button ui-widget ui-corner-all" title="Flip Vertically">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                        <path fill="#000000" d="M21,9L17,5V8H10V10H17V13M7,11L3,15L7,19V16H14V14H7V11Z" ></path>
                    </svg>
                </button>
                <button id="rotate-anti-clock" class="button-regular ui-button ui-widget ui-corner-all" title="Rotate Anti-clockwise">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                ...
                <button id="crop" class="button-regular not-available ui-widget ui-corner-all" title="Crop">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                        <path fill="#000000" d="M7,17V1H5V5H1V7H5V17A2,2 0 0,0 7,19H17V23H19V19H23V17M17,15H19V7C19,5.89 18.1,5 17,5H9V7H17V15Z" ></path>
                    </svg>
                </button>
                <button id="flip-horizontal" class="button-regular ui-button ui-widget ui-corner-all" title="Flip Horizontally">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                        <path fill="#000000" d="M9,3L5,7H8V14H10V7H13M16,17V10H14V17H11L15,21L19,17H16Z" ></path>
                    </svg>
                </button>
                <button id="rotate-clock" class="button-regular ui-button ui-widget ui-corner-all" title="Rotate Clockwise">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                ...
                <button id="fit" class="button-regular not-available ui-widget ui-corner-all" title="Fit size">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
            ...
            <div style="padding: 1%;">
                <button id="pos-top-left" class="button-regular ui-button ui-widget ui-corner-all" title="Position top left corner">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                        <path fill="#000000" d="M19,17.59L17.59,19L7,8.41V15H5V5H15V7H8.41L19,17.59Z" ></path>
                    </svg>
                </button>
                <button id="pos-top" class="button-regular ui-button ui-widget ui-corner-all" title="Position top">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                        <path fill="#000000" d="M13,20H11V8L5.5,13.5L4.08,12.08L12,4.16L19.92,12.08L18.5,13.5L13,8V20Z" ></path>
                    </svg>
                </button>
                <button id="pos-top-right" class="button-regular ui-button ui-widget ui-corner-all" title="Position top right corner">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                        <path fill="#000000" d="M5,17.59L15.59,7H9V5H19V15H17V8.41L6.41,19L5,17.59Z" ></path>
                    </svg>
                </button>
                <button id="pos-left" class="button-regular ui-button ui-widget ui-corner-all" title="Position left">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                        <path fill="#000000" d="M20,11V13H8L13.5,18.5L12.08,19.92L4.16,12L12.08,4.08L13.5,5.5L8,11H20Z" ></path>
                    </svg>
                </button>
                <button id="pos-center" class="button-regular ui-button ui-widget ui-corner-all" title="Position center">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                ...
                <button id="pos-right" class="button-regular ui-button ui-widget ui-corner-all" title="Position right">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                        <path fill="#000000" d="M4,11V13H16L10.5,18.5L11.92,19.92L19.84,12L11.92,4.08L10.5,5.5L16,11H4Z" ></path>
                    </svg>
                </button>
                <button id="pos-bottom-left" class="button-regular ui-button ui-widget ui-corner-all" title="Position bottom left corner">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                        <path fill="#000000" d="M19,6.41L17.59,5L7,15.59V9H5V19H15V17H8.41L19,6.41Z" ></path>
                    </svg>
                </button>
                <button id="pos-bottom" class="button-regular ui-button ui-widget ui-corner-all" title="Position bottom">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                        <path fill="#000000" d="M11,4H13V16L18.5,10.5L19.92,11.92L12,19.84L4.08,11.92L5.5,10.5L11,16V4Z" ></path>
                    </svg>
                </button>
                <button id="pos-bottom-right" class="button-regular ui-button ui-widget ui-corner-all" title="Position bottom right corner">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
            ...
            <div style="padding: 1%;">
                <button id="layer-up" class="button-regular ui-button ui-widget ui-corner-all" title="Move one layer up">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                ...
                <button id="layer-down" class="button-regular ui-button ui-widget ui-corner-all" title="Move one layer down">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
            ...
            <div style="padding: 1%;">
                <button id="undo" class="button-regular not-available ui-widget ui-corner-all" title="Undo">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                ...
                <button id="hide" class="button-regular not-available ui-widget ui-corner-all" title="Hide">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                ...
                <button id="clear" class="button-regular ui-button ui-widget ui-corner-all" title="Clear">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                        <path fill="#000000" d="M20,4C21.11,4 22,4.89 22,6V18C22,19.11 21.11,20 20,20H4C2.89,20 2,19.11 2,18V6C2,4.89 2.89,4 4,4H20M8.5,15V9H7.25V12.5L4.75,9H3.5V15H4.75V11.5L7.3,15H8.5M13.5,10.26V9H9.5V15H13.5V13.75H11V12.64H13.5V11.38H11V10.26H13.5M20.5,14V9H19.25V13.5H18.13V10H16.88V13.5H15.75V9H14.5V14A1,1 0 0,0 15.5,15H19.5A1,1 0 0,0 20.5,14Z" ></path>
                    </svg>
                </button>
                <button id="redo" class="button-regular not-available ui-widget ui-corner-all" title="Redo">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
            ...
            <div style="padding: 1%;">
                <button id="import-camera" class="button-regular ui-button ui-widget ui-corner-all" title="Import image using camera">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                ...
                <button id="import-template" class="button-regular ui-button ui-widget ui-corner-all" title="Import image from templates">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                ...
                <button id="import-upload" class="button-regular ui-button ui-widget ui-corner-all" title="Import image from device">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
            ...
            <div style="padding: 1%;">
                <button id="attachImage" class="button-regular ui-button ui-widget ui-corner-all" title="Attach image">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                ...
                <button id="attachVideo" class="button-regular ui-button ui-widget ui-corner-all" title="Attach video">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                ...
                <button id="attachAudio" class="button-regular ui-button ui-widget ui-corner-all" title="Attach audio">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                ...
                <button id="attachNote" class="button-regular ui-button ui-widget ui-corner-all" title="Attach note">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                ...
                <button id="attachFile" class="button-regular ui-button ui-widget ui-corner-all" title="Attach file">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
            ...
            <div style="padding: 1%;">
                <button id="print" class="button-regular ui-button ui-widget ui-corner-all" title="Print">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                        <path fill="#000000" d="M18,3H6V7H18M19,12A1,1 0 0,1 18,11A1,1 0 0,1 19,10A1,1 0 0,1 20,11A1,1 0 0,1 19,12M16,19H8V14H16M19,8H5A3,3 0 0,0 2,11V17H6V21H18V17H22V11A3,3 0 0,0 19,8Z" ></path>
                    </svg>
                </button>
            ...
            <div style="padding: 1%;">
                <button id="save-pdf" class="button-regular ui-button ui-widget ui-corner-all" title="Save as PDF">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                ...
                <button id="save-jpg" class="button-regular ui-button ui-widget ui-corner-all" title="Save as JPG">
                    jpg
                </button>
                <button id="save-png" class="button-regular ui-button ui-widget ui-corner-all" title="Save as PNG">
                    png
                </button>
                <!--<button id="save-json" class="button-small not-available ui-widget ui-corner-all">-->
                <!--.json-->
                <!--</button>-->
                <!--<button id="save-svg" class="button-small not-available ui-widget ui-corner-all">-->
                <!--.svg-->
                <!--</button>-->
            </div>
        </div>
    ...
    <div id="canvasContainer" class="canvasContainer">
        <div id="canvasWrapper" style="height: 100%; width: 100%; position: relative;">
            <canvas id="canvas" width="770" height="628" ></canvas>
            <button id="zoom-in" class="button-canvas" style="position: absolute; top: 10px; right: 10px;" title="Zoom in">
                <svg style="width:24px;height:24px" viewBox="0 0 24 24">
            ...
            <button id="zoom-reset" class="button-canvas" style="position: absolute; top: 50px; right: 10px;" title="Reset zoom">
                <svg style="width:24px;height:24px" viewBox="0 0 24 24">
            ...
            <button id="zoom-out" class="button-canvas" style="position: absolute; top: 90px; right: 10px;" title="Zoom out">
                <svg style="width:24px;height:24px" viewBox="0 0 24 24">
            ...
            <button id="pan-left" class="button-canvas" style="position: absolute; bottom: 50px; right: 90px;" title="Move canvas left">
                <svg style="width:24px;height:24px" viewBox="0 0 24 24">
            ...
            <button id="pan-up" class="button-canvas" style="position: absolute; bottom: 90px; right: 50px;" title="Move canvas up">
                <svg style="width:24px;height:24px" viewBox="0 0 24 24">
            ...
            <button id="pan-center" class="button-canvas" style="position: absolute; bottom: 50px; right: 50px;" title="Re-center canvas position">
                <svg style="width:24px;height:24px" viewBox="0 0 24 24">
            ...
            <button id="pan-right" class="button-canvas" style="position: absolute; bottom: 50px; right: 10px;" title="Move canvas right">
                <svg style="width:24px;height:24px" viewBox="0 0 24 24">
            ...
            <button id="pan-down" class="button-canvas" style="position: absolute; bottom: 10px; right: 50px;" title="Move canvas down">
                <svg style="width:24px;height:24px" viewBox="0 0 24 24">
    ...
    <button id="shape-line" class="button-small float-left" style="margin: 1%" title="Line">
        <svg style="width:24px;height:24px" viewBox="0 0 24 24">
            <path fill="#000000" d="M15,3V7.59L7.59,15H3V21H9V16.42L16.42,9H21V3M17,5H19V7H17M5,17H7V19H5" ></path>
        </svg>
    </button>
    <button id="shape-arrow" class="button-small float-left" style="margin: 1%" title="Arrow">
        <svg style="width:24px;height:24px" viewBox="0 0 24 24">
            <path fill="#000000" d="M5,17.59L15.59,7H9V5H19V15H17V8.41L6.41,19L5,17.59Z" ></path>
        </svg>
    </button>
    <button id="shape-circle" class="button-small float-left" style="margin: 1%" title="Circle">
        <svg style="width:24px;height:24px" viewBox="0 0 24 24">
    ...
    <button id="shape-rectangle" class="button-small float-left" style="margin: 1%" title="Rectangle">
        <svg style="width:24px;height:24px" viewBox="0 0 24 24">
            <path fill="#000000" d="M19,6H22V8H19V11H17V8H14V6H17V3H19V6M17,17V14H19V19H3V6H11V8H5V17H17Z" ></path>
        </svg>
    </button>
    <button id="shape-triangle" class="button-small float-left" style="margin: 1%" title="Triangle">
        <svg style="width:24px;height:24px" viewBox="0 0 24 24">
            <path fill="#000000" d="M12,2L1,21H23M12,6L19.53,19H4.47" ></path>
        </svg>
    </button>
    <button id="shape-polygon" class="button-small float-left" style="margin: 1%" title="Polygon">
        <svg style="width:24px;height:24px" viewBox="0 0 24 24">
    ...
    <div id="dialog-upload-progress" title="Saving data...">
        <p>File and annotation data progress will be shown here.</p>
    </div>
</body>