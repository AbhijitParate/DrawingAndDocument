...
<div id="controlsContainer" class="controlsContainer">
    <div id="controls">
        ...
        <div style="padding: 1%;">
            <button type="button" id="undo" class="button-regular ui-button ui-widget ui-corner-all" title="Undo">
                <svg style="width:24px;height:24px" viewBox="0 0 24 24">
            ...
            <button type="button" id="redo" class="button-regular ui-button ui-widget ui-corner-all" title="Redo">
                <svg style="width:24px;height:24px" viewBox="0 0 24 24">
        ...
        <div style="padding: 1%;">
            <button type="button" id="backup" class="button-regular ui-button ui-widget ui-corner-all" title="Backup drawing">
                <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                    <path fill="#000000" d="M17,13L12,18L7,13H10V9H14V13M19.35,10.03C18.67,6.59 15.64,4 12,4C9.11,4 6.6,5.64 5.35,8.03C2.34,8.36 0,10.9 0,14A6,6 0 0,0 6,20H19A5,5 0 0,0 24,15C24,12.36 21.95,10.22 19.35,10.03Z" ></path>
                </svg>
            </button>
            <button type="button" id="restore" class="button-regular ui-button ui-widget ui-corner-all" title="Restore drawing">
                <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                    <path fill="#000000" d="M14,13V17H10V13H7L12,8L17,13M19.35,10.03C18.67,6.59 15.64,4 12,4C9.11,4 6.6,5.64 5.35,8.03C2.34,8.36 0,10.9 0,14A6,6 0 0,0 6,20H19A5,5 0 0,0 24,15C24,12.36 21.95,10.22 19.35,10.03Z" ></path>
                </svg>
            </button>
        </div>
    </div>
