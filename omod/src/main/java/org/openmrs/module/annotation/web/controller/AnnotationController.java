 ...
 */
@Controller("${rootrootArtifactId}.AnnotationController")
@RequestMapping(value = "module/annotation/annotation.form")
public class AnnotationController {
	...
	private final String VIEW = "/module/annotation/annotation";
