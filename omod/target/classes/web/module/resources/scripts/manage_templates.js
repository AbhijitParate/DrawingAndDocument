...
$(document).ready(function() {
    ...
    function uploadFiles(fileName,fileDataUrl) {
        ...
        xhr.open('POST', '../ws/rest/v1/docsanddrawing/template/upload', true);
        xhr.send(data);
    ...
    function createListItem(templateName) {
        ...
        let a_view = $("<a/>")
            .attr("href", "../ws/rest/v1/docsanddrawing/template/get/" + templateName)
    ...
    function onTemplateSelected(templateName) {
        var url = "../ws/rest/v1/docsanddrawing/template/get/" + templateName;
